...
**Disclaimer - On a windows machine you need to use Git Bash, and install JQ to your git bash folder using:**
```sh
...
* `scraper_project_backend_bg.wasm`: What the Rust code compiles to.
* `scraper_project_backend.js`: Auto-generated binding between Rust and JS.
